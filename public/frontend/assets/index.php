...
<body>
     ...
     <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
        <a class="navbar-brand" href="#">E-Sidokare</a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link active"  data-scroll-nav="0" href="#home">Beranda</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-scroll-nav="1"  href="#features">Fitur</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-scroll-nav="2"  href="#fun-facts">Fun Facts</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-scroll-nav="3"  href="#app-screenshots">Tampilan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-scroll-nav="4"  href="#how-it-works">Cara Kerja</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-scroll-nav="5"  href="#contact">Kontak</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-scroll-nav="6"  href="#">Masuk</a>
              </li>
          </ul>
        </div>
        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7">
                        <div class="home-text">
                            ...
                            <div class="home-btn">
                                <a href="#" class="btn btn-1"><i class="fab fa-google-play"></i> Download Sekarang</a>
                    ...
                    <div class="col-md-5 text-center">
                        <div class="home-img">
                            ...
                            <img src="img/1.png" alt="Sidokare">
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-5 d-flex align-items-center justify-content-center">
              <div class="fun-facts-img">
                <img src="img/1.png" alt="fun facts">
              </div>
            </div>
